...
# COMMAND ----------
# Get all secrets required to integrate with kafka server from function get_kafka_serets() using databricks secrets utilty.
...
- Step 2 streams data from Kafka topic Customers to the Customers table Bronze layer.
...
try:
    ...
    books_writter = bronze_ingestion.ingest_to_customers_table(topic="customers",
                                                            outputMode="append", 
