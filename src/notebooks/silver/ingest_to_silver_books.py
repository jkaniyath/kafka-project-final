...
1. SilverBooksIngestion: Likely responsible for ingesting book data into the silver layer of the data pipeline.
...
from python_package.silver.silver_books_ingestion import SilverBooksIngestion
...
try:
    books_ingestion = SilverBooksIngestion(spark=spark, base_checkpoint_path=checkpoint_location, env=env)
    books_writter = books_ingestion.silver_books_ingestion(processing_time="30 seconds")
